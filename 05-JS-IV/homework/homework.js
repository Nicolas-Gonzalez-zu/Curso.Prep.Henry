...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  objeto[property] = null; //No es posible con objeto.property = null; ????
  return objeto;
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento = function(){
    return this.precio - (this.precio * this.porcentajeDeDescuento); //aqui se puede utilizar this ya que se infiere el objeto producto.
  }
  return producto;
